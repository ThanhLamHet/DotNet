...
namespace Lab8_QuanLySV.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ThanhLamHet\\SQLEXPRESS;Database=QuanLySV;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<KetQua>(entity =>
        {
            entity.HasKey(e => new { e.MaSo, e.MaMh }).HasName("PK__KetQua__A5575580CD7B88EA");
        ...
        {
            entity.HasKey(e => e.MaKhoa).HasName("PK__KHOA__65390405028A282C");
        ...
        {
            entity.HasKey(e => e.MaMh).HasName("PK__Mon__2725DFD9B88C3126");
        ...
        {
            entity.HasKey(e => e.MaSo).HasName("PK__SinhVien__2725087D586B52E7");
